    ...
    <div class="aaa_pts_3">
        ...
        <li class="product"><div class="d1 dx2">优惠券信息</div></li>
         ...
         <!-- <li>
            ...
            <div>
              <input class="inp_1 inp_6" name="point" id="point" value="<?php ?>" />
         ...
         <li>
            ...
            <div>
              ...
              <span style="color:red;margin-left:5px;">&nbsp;* 优惠券总的发行数量</span>
            </div>
         </li>
         <li>
         ...
         <?php if ($voucher['proid']!='all' && $voucher['proid']!='' && $voucher['pro_list']) { ?>
          <li>
            ...
            <div>
              <?php if(is_array($voucher['pro_list'])): $i = 0; $__LIST__ = $voucher['pro_list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><img src="/minisjksjpjpfshop/Data/<?php echo ($v); ?>" width="100px" height="100px" /><?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
          </li>
         <?php } ?>
