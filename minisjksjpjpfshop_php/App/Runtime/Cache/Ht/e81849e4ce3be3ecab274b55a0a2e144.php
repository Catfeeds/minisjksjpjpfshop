...
<script type="text/javascript" src="/minisjksjpjpfshop/Public/ht/js/jquery-1.8.3.min.js"></script>
</head>
<body>
      ...
      <ul class="aaa_pts_5">
        <?php if ($info['link']=='list') { ?>
         ...
         <li data-index="0">
            ...
            <div>
              <?php if ($info['photo']) { ?>
                <img src="/minisjksjpjpfshop/Data/<?php echo $info['photo']; ?>" width="70" height="70" /><br /><br />
              <?php } ?>
