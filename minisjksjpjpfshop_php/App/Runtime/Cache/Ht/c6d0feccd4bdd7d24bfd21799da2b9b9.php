...
<div class="aaa_pts_left_3" style="display:none;" id="join">
 <ul class="aaa_pts_left_2">
   <li>
       <a href="<?php echo U('Join/index');?>" target="iframe">待审核</a>
   </li>
    <li>
       <a href="<?php echo U('Join/audited');?>" target="iframe">已审核商家</a>
   </li>
 </ul>
</div>
...
<div class="aaa_pts_left_3" style="display:none;" id="product">
 <ul class="aaa_pts_left_2">
   ...
   <li>
       <a href="<?php echo U('Product/pro_tj');?>" target="iframe">产品推荐管理</a>
   </li>
   <!-- <li>
