...
<script type="text/javascript" src="/minisjksjpjpfshop/Public/ht/js/mydate.js"></script>
<style>
...
<div class="aaa_pts_show_1">【 产品栏目管理 】</div>
...
<div class="aaa_pts_show_2">
    ...
    <div class="aaa_pts_3">
		<form action="<?php echo U('save_tj');?>" method="post" onsubmit="return ac_from();" enctype="multipart/form-data">
		<ul class="aaa_pts_5">
        <li class="product"><div class="d1 dx2">产品栏目信息</div></li>
         <li class="product">
            <div class="d1">栏目名称:</div>
            <div>
              <input class="inp_1" name="name" id="name" value="<?php echo ($tj["name"]); ?>"/>
            </div>
         </li>
         ...
         <li>
            <div class="d1">产品:</div>
            <div>
              <input class="inp_1" id="proid" name="proid" value="<?php echo $tj['pid']; ?>" readonly="readonly"/>
        ...
        <li><input type="submit" name="submit" value="提交" class="aaa_pts_web_3" border="0" id="aaa_pts_web_s">
          <input type="hidden" name="id" id='id' value="<?php echo ($tj["id"]); ?>">
        </li>
      </ul>
      </form>
